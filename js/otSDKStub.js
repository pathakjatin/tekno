var OneTrustStub = ((t) => {
  var a,
    ...
    s =
      (((g = y = y || {})[(g.Days = 1)] = "Days"),
      (g[(g.Weeks = 7)] = "Weeks"),
      (g[(g.Months = 30)] = "Months"),
      (g[(g.Years = 365)] = "Years"),
      ((g = e = e || {}).Name = "OTGPPConsent"),
      (g[(g.ChunkSize = 4e3)] = "ChunkSize"),
      (g.ChunkCountParam = "GPPCookiesCount"),
      ((g = a = a || {}).CPRA = "usca"),
      (g.CCPA = "usca"),
      (g.CDPA = "usva"),
      (g.USNATIONAL = "usnat"),
      ...
      (g[(g.CCPA = 8)] = "CCPA"),
      (g[(g.CDPA = 9)] = "CDPA"),
      (g[(g.USNATIONAL = 7)] = "USNATIONAL"),
      (g[(g.COLORADO = 10)] = "COLORADO"),
      (g[(g.UCPA = 11)] = "UCPA"),
      (g[(g.CTDPA = 12)] = "CTDPA"),
      (g[(g.IAB2V2 = 2)] = "IAB2V2"),
      "geo"),
    ...
    p = (e.Name, "PRODUCTION"),
    n =
      (((g = {})[y.Days] = "PCenterVendorListLifespanDay"),
      (g[y.Weeks] = "LfSpnWk"),
      (g[y.Months] = "PCenterVendorListLifespanMonth"),
      (g[y.Years] = "LfSpnYr"),
  ...
  var d = new (function () {
    ...
    m =
      ((h.initCSPTrustedType = function (t) {
        var n = new URL(t);
        window.DOMPurify &&
          window.trustedTypes &&
  ...
  (f.prototype.initConsentSDK = function () {
    ...
    (f.prototype.captureNonce = function () {
      this.nonce =
        l.stubScriptElement.nonce ||
        l.stubScriptElement.getAttribute("nonce") ||
        null;
    }),
    (f.prototype.fetchBannerSDKDependency = function () {
      this.setDomainDataFileURL(),
        (this.crossOrigin =
          l.stubScriptElement.getAttribute("crossorigin") || null),
        (this.previewMode =
          "true" === l.stubScriptElement.getAttribute("data-preview-mode")),
    ...
    (f.prototype.getLocation = function (t) {
      if (
        ...
        m.checkAndAssignCspTrustedTypeEnabled(t) &&
          m.initCSPTrustedType(l.storageBaseURL),
        !t.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
    ...
    (f.prototype.getGeolocationURL = function (t) {
      ...
      var e =
        "" +
        l.stubScriptElement.getAttribute("src").split(l.stubFileName)[0] +
        t.Version;
    ...
    (f.prototype.setOTDataLayer = function () {
      ...
      this.otDataLayer = {
        ignore: (e && "true" === t) || (e && "" === t),
        name:
          l.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer",
      };
    }),
    ...
    (f.prototype.validateIABGlobalScope = function () {
      var t = this.readCookieParam(
        l.optanonCookieName,
        l.oneTrustIsIABCrossConsentEnableParam
      );
      t
        ? "true" === t
          ? ((l.hasIABGlobalScope = !0), (l.isStubReady = !1))
          : ((l.hasIABGlobalScope = !1),
            (l.IABCookieValue = this.getCookie(l.oneTrustIABCookieName)))
        : (l.isStubReady = !1);
    }),
    (f.prototype.validateIABGDPRApplied = function () {
      ...
      t
        ? this.isBoolean(t)
          ? (l.oneTrustIABgdprAppliesGlobally = "true" === t)
          : (l.oneTrustIABgdprAppliesGlobally = 0 <= l.EUCOUNTRIES.indexOf(t))
        : (l.isStubReady = !1);
    }),
    ...
    (f.prototype.updateGtmMacros = function () {
      for (var t = [], e = l.optanonHtmlGroupData.length, i = 0; i < e; i++)
        this.endsWith(l.optanonHtmlGroupData[i], ":1") &&
          t.push(l.optanonHtmlGroupData[i].replace(":1", ""));
      for (e = l.optanonHostData.length, i = 0; i < e; i++)
        this.endsWith(l.optanonHostData[i], ":1") &&
          t.push(l.optanonHostData[i].replace(":1", ""));
      for (e = l.genVendorsData.length, i = 0; i < e; i++)
        this.endsWith(l.genVendorsData[i], ":1") &&
          t.push(l.genVendorsData[i].replace(":1", ""));
      for (e = l.vendorsServiceData.length, i = 0; i < e; i++)
        this.endsWith(l.vendorsServiceData[i], ":1") &&
          t.push(l.vendorsServiceData[i].replace(":1", ""));
      var n,
    ...
    (f.prototype.setStubScriptElement = function () {
      l.stubScriptElement = document.querySelector(
        "script[src*='" + l.stubFileName + "']"
      );
      var t = l.stubScriptElement && l.stubScriptElement.getAttribute("src"),
        t = t && this.getStubQueryParam(t, "did");
      l.stubScriptElement &&
      l.stubScriptElement.hasAttribute(l.DATAFILEATTRIBUTE)
        ? (this.domainId = l.stubScriptElement
            .getAttribute(l.DATAFILEATTRIBUTE)
            .trim())
        : t
        ? (this.domainId = t)
        : l.stubScriptElement ||
          ((l.stubScriptElement = document.querySelector(
            "script[src*='" + l.migratedCCTID + "']"
          )),
          l.stubScriptElement &&
            ((l.isMigratedURL = !0),
    ...
    (f.prototype.setDomainDataFileURL = function () {
      ...
      t &&
        (l.isMigratedURL
          ? (l.storageBaseURL = t.split("/consent/" + l.migratedCCTID)[0])
          : (l.storageBaseURL = (
              e
                ? t.split("/consent")
                : t.split("/scripttemplates/" + l.stubFileName)
            )[0])),
        ...
        this.isPreview && -1 === this.domainId.indexOf("test")
          ...
          : (this.isPreview = !1),
        (l.bannerBaseDataURL =
          l.storageBaseURL && l.storageBaseURL + "/consent/" + this.domainId),
        (l.bannerDataParentURL =
          l.bannerBaseDataURL + "/" + this.domainId + ".json");
    }),
    ...
    (this.iabType = null),
      ...
      (this.addBannerSDKScript = function (t) {
        ...
        [
          ...
          l.stubScriptElement.getAttribute(t) &&
